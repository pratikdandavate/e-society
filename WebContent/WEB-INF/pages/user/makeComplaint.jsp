...
<table style="background-color: cyan; margin: auto;" border="1">
			...
			<tr>
				<td><input type="submit" value="Make complaint" /></td>
			</tr>
		</table>
</form>
</body>
...
$(document).ready(function(){
    ...
    $("#sellButton").click(function () {
    	...
    	newTextBoxDiv.after('<label>Sell Price : </label>' + '<input type="text" name="textbox" id="textbox" value="" />').html('<form method="post" action="sellHouse"><label>Rent Price : </label>' + '<input type="text" name="rentPrice" id="rentPrice" value="" /><input type="hidden" name="rentId" value="${sessionScope.user.userId}"><input type="submit" value="Submit"></form>');
...
<table style="margin: auto;" border="1">
			...
			<input type="hidden" value='${sessionScope.user.userId}' name="userid">
				<tr>
				<td>Complain :</td>
				<td><textarea  name="complaint" required></textarea></td>
			</tr>
			<tr>
				<td><input type="submit" value="Make complaint"/></td>
			</tr>
