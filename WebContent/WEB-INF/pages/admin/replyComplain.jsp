...
<tr><td>Subject :</td><td> ${sessionScope.complaintById.subject}</td></tr> 
<tr><td>Complaint :</td><td>  ${sessionScope.complaintById.complaint} </td></tr> 
<tr><td>Reply : </td><td><textarea name="reply"> </textarea></td></tr>
<input type="hidden" value="${sessionScope.complaintById.complaintId}" name="id">
